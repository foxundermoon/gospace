...
func CreateWindow(title string, wndproc uintptr) (hwnd syscall.Handle) {
	...
	wh, e := CreateWindowEx(
		0,
		wcname,
		syscall.StringToUTF16Ptr(title), WS_VISIBLE|WS_THICKFRAME|WS_CAPTION|WS_CLIPSIBLINGS|WS_CLIPCHILDREN|WS_EX_APPWINDOW|WS_EX_ACCEPTFILES|WS_MAXIMIZEBOX|WS_MINIMIZEBOX,
